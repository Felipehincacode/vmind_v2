...
-- Tabla de roadmaps (rutas de aprendizaje)
CREATE TABLE roadmaps (
    ...
    estimated_time INT DEFAULT 0, -- en minutos
    user_id CHAR(36),
    creation_date DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE SET NULL
);

-- Tabla de niveles dentro de los roadmaps
CREATE TABLE levels (
...
-- Tabla de tareas dentro de los niveles
CREATE TABLE tasks (
...
-- Tabla de tareas de usuario (progreso)
